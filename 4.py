...
with open(FILE_PATH, 'r') as f:
    text_file = MIMEApplication(f.read(), _subtype='txt')
    text_file.add_header('Content-Disposition', 'attachment', filename=os.path.basename(FILE_PATH))
    email_message.attach(text_file)
